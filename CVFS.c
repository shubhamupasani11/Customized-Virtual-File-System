...
//user defined structures with typedef

/////////////////////////////////////////////////////
//structure name: superbolck
//members:TotalInodes,FreeInode with typedef
/////////////////////////////////////////////////////
typedef struct superbolck
{
	int TotalInodes;
	int FreeInode;
...
//members:FileName[50],InodeNumber,FileSize,FileActualSize,FileType,buffer pointer,LinkCount,ReferenceCount,permission,next pointer(pointing to next inode) with typedef
/////////////////////////////////////////////////////
...
//members:readoffset,writeoffset,count,mode,ptrinode with typedef
//////////////////////////////////////////////////////////////
...
///////////////////////////////////////////////////////////
//structure name:ufdt
//members: PFILETABLE ptrfiletable with typedef
////////////////////////////////////////////////////////////
typedef struct ufdt
{
...
//////////////////////////////////////////////////////////////////
//Function name:man
//Function Date:10/06/2021
//Author: Shubham Upasani
//Parameters: command name
//Description:This Function used to display usage and description of particular command
//Return value:NONE
/////////////////////////////////////////////////////////////
void man(char *name)
{
...
//Author: Shubham Upasani
//Parameters: NONE
//Description: This Function used to  display command's use 
//Return value: NONE
/////////////////////////////////////////////////////////////
void DisplayHelp()
{
...
//Function Date:12/06/2021
//Author: Shubham Upasani
//Parameters: FileName
//Description: This Function is used to get File Descriptor of the File
...
//Author: Shubham Upasani
//Parameters: FileName
//Description: This Function is used to get INODE of given File
...
//Function Date:11/06/2021
//Author: Shubham Upasani
//Parameters: NONE
//Description:This Function is used to create Disk Inode List Block
//Return value: NONE
/////////////////////////////////////////////////////////////
void CreateDILB()
{
...
//Author: Shubham Upasani
//Parameters:NONE
//Description:This Function is used to initialize SuperBlock
//Return value: NONE
/////////////////////////////////////////////////////////////
...
//Function Date:12/06/2021
//Author: Shubham Upasani
//Parameters:FileName ,permission
...
//Author: Shubham Upasani
//Parameters:FileName
//Description:This Function is used to remove file
//Return value:Integer
/////////////////////////////////////////////////////////////
...
//Function Date:14/06/2021
//Author: Shubham Upasani
//Parameters: fd,address,isize
...
//Function Date:15/06/2021
//Author: Shubham Upasani
//Parameters: fd,address,isize
//Description: This Function is used to write the File
//Return value:Integer
/////////////////////////////////////////////////////////////
...
//Function Date:18/06/2021
//Author: Shubham Upasani
//Parameters: NONE
//Description: This Function is used to close  all the open Files
//Return value:NONE
//////////////////////////////////////////////////////////////////
void CloseAllFile()
{
...
//Function Date:20/06/2021
//Author: Shubham Upasani
//Parameters: File Descriptor,size,offset position
//Description: This Function is used to change the offset of the file
//Return value:Integer
//////////////////////////////////////////////////////////////////
...
//Function Date:19/06/2021
//Author: Shubham Upasani
//Parameters: NONE
//Description: This Function is used to list out the all the information of files
//Return value: NONE
//////////////////////////////////////////////////////////////////
void ls_file()
{
...
//Description: This Function is used to display the information of the File
//Return value:Integer
//////////////////////////////////////////////////////////////////
...
//Function Date:21/06/2021
//Author: Shubham Upasani
//Parameters: File Name
//Description: This Function is used to remove the data from the File
//Return value:Integer
//////////////////////////////////////////////////////////////////
	...
	while(1)
	{
		...
		else if(count==2)
		{
			...
			else if(_stricmp(command[0],"write")==0)
			{
				...
				if(ret==-2)
				{
					printf("Error:There is no suffi memory to write\n");
				}
				if(ret==-3)
				{
		...
		else if(count==3)
		{
			if(_stricmp(command[0],"create")==0)
			{
				...
				if(ret>=0)
				{
					printf("File creted successfully with file desciptor :%d\n",ret);
				}
				if(ret==-1)
				{
					printf("ERROR : Incorrect parameters\n"); 
			...
			else if(_stricmp(command[0],"open")==0)
			{
				...
				if(ret>=0)
				{
					printf("\n file opened successfully with file desciptor is:%d\n",ret);
				}
				if(ret==-2)
				{
